...
class HiveAnimationController {
  ...
  initState() {
    ...
    animationSecondaryTutorial = Tween<double>(begin: 0, end: 1).animate(
      CurvedAnimation(
          parent: animationControllerSecondaryTutorial, curve: Curves.easeOut),
    );
