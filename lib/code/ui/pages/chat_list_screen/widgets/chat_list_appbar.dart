...
class _ChatListAppsBarState extends State<ChatListAppsBar> {
  // Blocs
  late ChatListScreenBloc _chatListScreenBloc;

  @override
  void initState() {
    _chatListScreenBloc = BlocProvider.of<ChatListScreenBloc>(context);
    super.initState();
  }
  ...
  void _startSearching() {
    ...
    _chatListScreenBloc.add(
      StartChatSearching(),
    );
  }

  void _searching(String value) => _chatListScreenBloc.add(
